...
file_path = "data/simulations/interventions/w3_by_100/"
...
baseline_path = "data/simulations/baseline/w3_by_100/"
...
def load_intervention_data(file, file_path="data/simulations/interventions/w3_by_100/",
...
def load_baseline_data(file, file_path="data/simulations/baseline/w3_by_100/",
                       P=simulation_parameters["P"]):
    # Load data
    # with open(file_path + file, "r") as f:
    #     results_json = json.load(f)
...
df.to_csv("data/df_results3_intervention_w3_by_100.csv")
# %%
df_base = list(map(load_baseline_data, baseline_files))
df_base = pd.DataFrame(df_base)

df_base.to_csv("data/df_results3_baseline_w3_by_100.csv")
