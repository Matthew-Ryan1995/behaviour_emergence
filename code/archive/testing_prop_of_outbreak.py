...
#     p1N = beta/(beta + (1-c) * beta + gamma + w3)
#     p2N = (1-c)*beta/(beta + (1-c) * beta + gamma + w3)
#     p3N = gamma/(beta + (1-c) * beta + gamma + w3)
#     p4N = w3/(beta + (1-c) * beta + gamma + w3)

#     p1B = ((1-p) * beta) / ((1-p) * beta + (1-c)*(1-p)*beta + gamma + a1 + a2)
#     p2B = ((1-c)*(1-p) * beta) / ((1-p) * beta +
#                                   (1-c)*(1-p)*beta + gamma + a1 + a2)
#     p3B = gamma / ((1-p) * beta + (1-c)*(1-p)*beta + gamma + a1 + a2)
#     p4B = (a1 + a2) / ((1-p) * beta + (1-c)*(1-p)*beta + gamma + a1 + a2)
