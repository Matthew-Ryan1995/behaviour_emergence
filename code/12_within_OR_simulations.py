...
def run_simulation_with_event(tmp,
    ...
    save_name = f"/OR_{OR}_p_{p}_seed_{simulation_parameters['seed']}_tend_{simulation_parameters['t_end']}_trajectories_{simulation_parameters['num_trajectory']}.json"
