...
def load_bstar_data(file, file_path="../data/simulations/Bstar_by_R0/",
...
df = df.sort_values(by=["Bstar", "R0"])

df.to_csv("../data/df_results2_Bstar_by_R0.csv")
