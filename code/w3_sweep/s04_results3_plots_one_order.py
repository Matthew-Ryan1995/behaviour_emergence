...
Appendix w3 sweep plots by 1 order of magnitude
...
file_path = "data/df_results3_intervention_w3_by_10.csv"
df = pd.read_csv(file_path, index_col=0)

file_path_baseline = "data/df_results3_baseline_w3_by_10.csv"
...
plt.tight_layout()
plt.savefig("figs/results3_log_odds_w3_by_10.png",
            dpi=dpi,
            bbox_inches="tight")
plt.close()
...
plt.tight_layout()
plt.savefig("figs/results3_infections_saved_w3_by_10.png",
            dpi=dpi,
            bbox_inches="tight")
plt.close()
...
plt.tight_layout()
plt.savefig("figs/results3_infections_saved_conditional_w3_by_10.png",
            dpi=dpi,
            bbox_inches="tight")
plt.close()
