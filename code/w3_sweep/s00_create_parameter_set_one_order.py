...
params["B_const"] = get_w3(Bstar_min=B_star_min, params=params) * 10
...
with open("data/simulation_parameters_w3_by_10.json", "w") as f:
...
with open("data/intervention_parameters_w3_by_10.json", "w") as f:
