...
Appendix: Between odds ratio collect data
...
file_path = "../data/simulations/between_OR/"
...
def load_bstar_data(file, file_path="../data/simulations/between_OR/",
...
df.to_csv("../data/df_between_OR.csv")
