...
child_directory = parent_directory + "/large_baseline"
...
for i in range(20):
    ...
    save_file = child_directory + \
        f"/baseline_simulations_seed_{simulation_parameters['seed']}_tend_{simulation_parameters['t_end']}_trajectories_{simulation_parameters['num_trajectory']}.gz"
